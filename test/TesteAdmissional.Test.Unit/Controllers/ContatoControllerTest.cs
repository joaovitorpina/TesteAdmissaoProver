...
public class ContatoControllerTest
{
    ...
    [Fact]
    public async Task CreateContato_DeveRetornar_InternalServerError_Quando_CommandHandler_RetornarExcecao()
    {
        var mediator = new Mock<IMediator>();
        var request = new CreateContatoRequest
        {
    ...
    [Fact]
    public async Task UpdateContato_DeveRetornar_InternalServerError_Quando_CommandHandler_RetornarExcecao()
    {
        var mediator = new Mock<IMediator>();
        var request = new UpdateContatoRequest
        {
    ...
    [Fact]
    public async Task DeleteContato_DeveRetornar_InternalServerError_Quando_CommandHandler_RetornarExcecao()
    {
        var mediator = new Mock<IMediator>();
        var request = new DeleteContatoRequest
        {
    ...
    [Fact]
    public async Task ListContato_DeveRetornar_InternalServerError_Quando_CommandHandler_RetornarExcecao()
    {
        var mediator = new Mock<IMediator>();
